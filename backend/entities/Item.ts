...
export class Item {
    ...
    public isVehicle() {
        return [
            ...
            ItemType.BABY_MAMMOTH, ItemType.BOAR, ItemType.CRAB_BOSS
        ].includes(this.id);
    }
    ...
    public isHat() {
        return [
            ...
            ItemType.CROWN_BLUE, ItemType.CROWN_GREEN, ItemType.CROWN_GREEN,
    ...
    public isSword() {
        return [
            ...
            ItemType.PIRATE_SWORD, ItemType.CURSED_SWORD
        ].includes(this.id);
    }
