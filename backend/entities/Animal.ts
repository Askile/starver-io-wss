    ...
    private setupLoot() {
        switch (this.type) {
            case EntityType.WOLF:
                ...
                this.inventory.giveItem(ItemType.WOLF_FUR, 1);
            ...
            case EntityType.FOX:
                this.inventory.giveItem(ItemType.MEAT, 2);
                this.inventory.giveItem(ItemType.WINTER_FUR, 1);
                this.behaviour = BehaviourType.AGGRESSIVE;
            ...
            case EntityType.BEAR:
                ...
                this.inventory.giveItem(ItemType.WINTER_FUR, 2);
                this.behaviour = BehaviourType.AGGRESSIVE;
                this.spawnBiome = BiomeType.WINTER;
                this.score = 500;
                break;
            ...
            case EntityType.BABY_DRAGON:
                ...
                break;
            case EntityType.MAMMOTH:
                this.inventory.giveItem(ItemType.MAMMOTH_FUR, 10);
            ...
            case EntityType.BABY_MAMMOTH:
                this.inventory.giveItem(ItemType.MAMMOTH_FUR, 1);
                this.inventory.giveItem(ItemType.MEAT, 3);
                this.behaviour = BehaviourType.NEUTRAL;
                this.spawnBiome = BiomeType.WINTER;
                this.score = 600;
            ...
            case EntityType.SAND_WORM:
                ...
                break;
            case EntityType.KRAKEN:
                this.inventory.giveItem(ItemType.KRAKEN_FUR, 1);
                this.inventory.giveItem(ItemType.FISH, 5);
                this.behaviour = BehaviourType.AGGRESSIVE;
                this.spawnBiome = BiomeType.SEA;
                this.score = 2000;
                break;
            case EntityType.PIRANHA:
                this.inventory.giveItem(ItemType.FISH, 2);
                this.inventory.giveItem(ItemType.PIRANHA_SCALES, 1);
                this.behaviour = BehaviourType.AGGRESSIVE;
                this.spawnBiome = BiomeType.SEA;
                this.score = 600;
                break;
