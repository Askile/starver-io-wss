...
export class KitSystem {
    ...
    private getKit(id: number) {
        switch(id) {
            ...
            case 7: return [16000, [ItemType.BAG, 1], [ItemType.HOOD, 1], [ItemType.GOLD_HAMMER, 1], [ItemType.BANDAGE, 3], [ItemType.STONE_SWORD, 1], [ItemType.GOLD_PICK, 1], [ItemType.CAKE, 7], [ItemType.BOTTLE_FULL, 2], [ItemType.BIG_FIRE, 4], [ItemType.STONE, 150 ] , [ItemType.WOOD, 200], [ItemType.LOCK_PICK, 1]];
            ...
            case 9: return [16000, [ItemType.BAG, 1], [ItemType.GOLD_PICK, 1], [ItemType.FISH_COOKED, 16], [ItemType.BOTTLE_FULL, 1], [ItemType.BIG_FIRE, 6], [ItemType.BANDAGE, 3], [ItemType.DIVING_MASK, 1], [ItemType.STONE_SWORD, 1], [ItemType.BRIDGE, 16], [ItemType.STONE, 150 ] , [ItemType.WOOD, 200]];
