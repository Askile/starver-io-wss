...
export class CollisionSystem {
    ...
    public getClosestPointOnCircle(entity: Entity, obstacle: any, stop: boolean, multiply: number = 1) {
    ...
    public update(entity: Entity) {
        ...
        for (const obstacle of obstacles) {
            ...
            if(obst.length >= 2) {
                ...
                else entity.position.set(this.getClosestPointOnCircle(entity, obstacle, true));
            } else {
                entity.position.set(this.getClosestPointOnCircle(entity, obstacle, false));
            }
        }
