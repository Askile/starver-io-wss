...
class BuildingSystem {
    ...
    request(player, data) {
        ...
        for (const e of entities) {
            if ((this.isBridge(e.type) && this.isBridge(entity.type) && entity.position.x === e.position.x && entity.position.y === e.position.y) || e.radius && e.position.distance(entity.position) < e.radius + 45)
                return;
        }
        ...
        player.client.sendBinary(new Uint8Array([ClientPackets_1.ClientPackets.ACCEPT_BUILD, id]));
